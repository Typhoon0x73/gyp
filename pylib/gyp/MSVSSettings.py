...
_post_build_event = _Tool('PostBuildEvent', 'PostBuildEvent')
...
_Same(_compile, 'SDLCheck', _boolean)  # /sdl
_Same(_compile, 'ConformanceMode', _boolean)  # /permissive-
...
_Same(_post_build_event, 'Command', _string)
